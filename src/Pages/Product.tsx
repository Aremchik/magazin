        ...
        <div className="selected-product-page">
            ...
            <div className="selected-product-content">
                ...
                <div className="selected-product-price-block">
                    <img className="selected-product-img" src={require(`../UI/${product[0].image}`)} alt={product.category} />
                    <div className='price-block'>
                        <div className="selected-product-price">{product[0].price}</div>
                        <div className="selected-product-price-text">Чтобы офрмить заказ свяжитесь с нами</div>
                    </div>
                </div>
